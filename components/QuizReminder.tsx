...
function QuizReminder() {
    return (
        <div className='p-3' style={{ backgroundColor: appColor.primaryDarkColor, borderRadius: 10, margin: "10px 0px" }}>
            <h2 className={`text-16 font-bold`} style={{ color: appColor.lightTextColor, fontFamily: 'Lato-Bold' }}>
                Daily Quiz
            </h2>
            <div className="flex items-center" style={{marginTop: "10px"}}>
                <p className={`flex-1 pr-2 `} style={{ color: appColor.lightTextColor, fontFamily: 'Lato-Bold' }}>
            ...
            <p className={`text-13 font-semibold `} style={{ color: appColor.primaryColor, fontFamily: 'Lato-Bold' }}>
                12hrs Left
            </p>
        </div>
    );
